...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-full md:w-64 bg-slate-900 text-slate-100 flex flex-col shrink-0 md:min-h-[calc(100vh-61px)]">
      ...
      <div className="mt-auto p-4 border-t border-slate-800 text-xs text-slate-400 hidden md:block">
